...
cpf_enviado_pelo_usuario = '020.485.555-19' # cpf string recebido pelo usuario

cpf_limpo_enviado_pelo_usuario = cpf_enviado_pelo_usuario.replace('.','').replace('-','') # cpf retirado . e - 
cpf_int = int(cpf_limpo_enviado_pelo_usuario) # cpf limpo convertido de string para numero inteiro
...
if cpf_limpo_enviado_pelo_usuario == cpf_gerado_pelo_calculo and cpf_limpo_enviado_pelo_usuario == cpf_gerado_convertido:
    print('--------------------------')
    print(' é valido')
else:
    print('cpf invalido')
