...
# o importe decimal funcina melhor para números float muito grandes ou calculos que pecisao ser preciso, forma mas facild e usar e convertendo um string para decial ex comentado abaixo.
