...
print(pessoa.get('sobrenome', 'não existe'))# caso nao coloque nada valor padrão é None
if pessoa.get('sobrenome') is None:
    print('pessoa não tem sobrenome')
else:
    print(f'O sobrenome é'{pessoa['sobrenome']}')
