...
cpf_enviado_pelo_usuario = '014.150.534-45'  # cpf string recebido pelo usuário
...
for digitos in nove_digitos:
    ...
    # aqui é gerado o primeiro digito do calculo digitos * contador regressivo em ordem decrecente e ja somado cada resultado da multiplicacao mas soma dos resultados 1 a 1 ex... 1* 10 = 10 | 2*10 = 20 mas 10 =30
