...
if int_primeiro_valor > int_segundo_valor:
    print(f'O primeiro valor é {int_primeiro_valor } maior que o segundo {int_segundo_valor}')
elif int_primeiro_valor < int_segundo_valor:
    print(f'O primeiro Valor é {int_primeiro_valor} menor que o segundo valor {int_segundo_valor}')
else:
